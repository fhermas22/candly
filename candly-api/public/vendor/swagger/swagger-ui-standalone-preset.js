                    ...
                    t.exports = (function () {
                        ...
                        function setListBounds(t, e, r) {
                            ...
                            if (
                                ...
                                (l &&
                                    s > o &&
                                    (l = l.removeBefore(n, f, s - p)),
                                    l &&
                                        d < h &&
                                        (l = l.removeAfter(n, f, d - p)),
                                    p && ((s -= p), (c -= p)));
                            }
                            return t.__ownerID
                                ? ((t.size = c - s),
                    ...
                    (n(Sha512, o),
                        ...
                        (Sha512.prototype._update = function (t) {
                            ...
                            ((this._al = (this._al + l) | 0),
                                ...
                                (this._hh =
                                    (this._hh + f + getCarry(this._hl, m)) |
                                    0));
                        }),
            ...
            (() => {
                ...
                var jt = new st("tag:yaml.org,2002:pairs", {
                        ...
                        resolve: function resolveYamlPairs(t) {
                            ...
                            for (
                                ...
                                if (
                                    ((n = a[e]),
                                    "[object Object]" !== Ct.call(n))
                                )
                                    return !1;
                                if (1 !== (o = Object.keys(n)).length)
                                    return !1;
                                i[e] = [o[0], n[o[0]]];
                            }
                            return !0;
                ...
                var Lt = new st("tag:yaml.org,2002:set", {
                        ...
                        resolve: function resolveYamlSet(t) {
                            ...
                            var e,
                                r = t;
                            for (e in r)
                                if (qt.call(r, e) && null !== r[e]) return !1;
                            return !0;
                        },
                ...
                function storeMappingPair(t, e, r, n, o, i, a, s, u) {
                    ...
                    if (Array.isArray(o))
                        for (
                            c = 0,
                                f = (o = Array.prototype.slice.call(o)).length;
                            c < f;
                            c += 1
                        )
                            (Array.isArray(o[c]) &&
                ...
                function skipSeparationSpace(t, e, r) {
                    for (
                        var n = 0, o = t.input.charCodeAt(t.position);
                        0 !== o;
                    ) {
                            ...
                            1 === d
                                ? (s &&
                                  ...
                                  (function readFlowCollection(t, e) {
                                      ...
                                      for (
                                          null !== t.anchor &&
                                              (t.anchorMap[t.anchor] = i),
                                              h = t.input.charCodeAt(
                                                  ++t.position,
                                              );
                                          0 !== h;
                                      ) {
                ...
                function State(t) {
                    ((this.schema = t.schema || Nt),
                        ...
                        (this.flowLevel = rt.isNothing(t.flowLevel)
                            ? -1
                            : t.flowLevel),
                ...
                function writeBlockSequence(t, e, r, n) {
                    ...
                    for (o = 0, i = r.length; o < i; o += 1)
                        ((a = r[o]),
                            t.replacer &&
                                (a = t.replacer.call(r, String(o), a)),
                ...
                function detectType(t, e, r) {
                    ...
                    for (
                        i = 0,
                            a = (o = r ? t.explicitTypes : t.implicitTypes)
                                .length;
                        i < a;
                        i += 1
                    )
                ...
                function getDuplicateReferences(t, e) {
                    var r,
                        ...
                        i = [];
                    for (
                        inspectNode(t, o, i), r = 0, n = i.length;
                        r < n;
                        r += 1
                    )

    ...
    <div className="hidden lg:flex flex-1 flex-col justify-center px-20 relative overflow-hidden">
      <div
        ...
        style={{
          ...
          maskImage:
            "radial-gradient(ellipse 80% 80% at 40% 50%,black 10%,transparent 80%)",
        }}
      />
      ...
      <motion.p
        ...
        style={{ color: "#94a3b8" }}
      >
        Rejoignez des milliers de candidats qui ont trouvé leur prochaine
        opportunité via Candly. Sécurisé, rapide, premium.
      </motion.p>
      ...
      >
        <p
          ...
          style={{ color: "#e2e8f0" }}
        >
          &ldquo;En moins de deux semaines sur Candly, j&apos;ai décroché un
          entretien dans une scale-up béninoise. L&apos;interface est vraiment
          intuitive.&rdquo;
        </p>
...
export default function Auth() {
  ...
  const activeTab = modeFromUrl === AUTH_MODE.REGISTER ? "register" : "login";
